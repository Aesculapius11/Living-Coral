...
{% image "https://img.antares.xin/nwys/1.webp", "需要下载的文件" %}
...
{% image "https://img.antares.xin/nwys/2.webp", "上传文件" %}
...
{% image "https://img.antares.xin/nwys/3.webp", "解压结果如下" %}
...
{% image "https://img.antares.xin/nwys/4.webp", "配置文件" %}
...
{% image "https://img.antares.xin/nwys/5.webp", "在安全组内开启端口" %}
...
{% image "https://img.antares.xin/nwys/6.webp", "登录界面" %}

登录界面

进入面板后我们开始新增客户端

{% image "https://img.antares.xin/nwys/7.webp", "新增客户端" %}
...
{% image "https://img.antares.xin/nwys/8.webp", "新建客户端" %}
...
{% image "https://img.antares.xin/nwys/9.webp", "得到客户端命令" %}
...
{% image "https://img.antares.xin/nwys/10.webp", "解压获得的文件" %}
...
{% image "https://img.antares.xin/nwys/11.webp", "安装客户端" %}
...
{% image "https://img.antares.xin/nwys/12.webp", "启动服务" %}
...
{% image "https://img.antares.xin/nwys/13.webp", "面板" %}
...
{% image "https://img.antares.xin/nwys/14.webp", "添加隧道" %}
...
{% image "https://img.antares.xin/nwys/15.webp", "添加隧道" %}
...
{% image "https://img.antares.xin/nwys/16.webp", "放行端口" %}
...
{% image "https://img.antares.xin/nwys/17.webp", "防火墙" %}

开启防火墙

最后进游戏看一下延迟（这是我和朋友之前玩的一个整合包服）

{% image "https://img.antares.xin/nwys/18.webp", "" %}

{% image "https://img.antares.xin/nwys/19.webp", "" %}
...
>    {% image "https://img.antares.xin/nwys/20.png", "配置文件" %}
