...
description: 通过白嫖的服务器自建我的世界服务器的内网映射隧道以解决没有公网IP的问题
date: 2023-12-25
tags: [内网映射, 云服务器]
category: 技术
keywords: [MC, 内网映射, 服务器, 我的世界, 云服务器, Minecraft]
author: 星辰曦羽
cover: https://img.antares.xin/assets/nwys/8.webp
...
{% image "https://img.antares.xin/assets/nwys/1.webp", "需要下载的文件" %}
...
{% image "https://img.antares.xin/assets/nwys/2.webp", "上传文件" %}
...
{% image "https://img.antares.xin/assets/nwys/3.webp", "解压结果如下" %}
...
{% image "https://img.antares.xin/assets/nwys/4.webp", "配置文件" %}
...
{% image "https://img.antares.xin/assets/nwys/5.webp", "在安全组内开启端口" %}
...
{% image "https://img.antares.xin/assets/nwys/6.webp", "登录界面" %}

登录界面

进入面板后我们开始新增客户端

{% image "https://img.antares.xin/assets/nwys/7.webp", "新增客户端" %}
...
{% image "https://img.antares.xin/assets/nwys/8.webp", "新建客户端" %}
...
{% image "https://img.antares.xin/assets/nwys/9.webp", "得到客户端命令" %}
...
{% image "https://img.antares.xin/assets/nwys/10.webp", "解压获得的文件" %}
...
{% image "https://img.antares.xin/assets/nwys/11.webp", "安装客户端" %}
...
{% image "https://img.antares.xin/assets/nwys/12.webp", "启动服务" %}
...
{% image "https://img.antares.xin/assets/nwys/13.webp", "面板" %}
...
{% image "https://img.antares.xin/assets/nwys/14.webp", "添加隧道" %}
...
{% image "https://img.antares.xin/assets/nwys/15.webp", "添加隧道" %}
...
{% image "https://img.antares.xin/assets/nwys/16.webp", "放行端口" %}
...
{% image "https://img.antares.xin/assets/nwys/17.webp", "防火墙" %}

开启防火墙

最后进游戏看一下延迟（这是我和朋友之前玩的一个整合包服）

{% image "https://img.antares.xin/assets/nwys/18.webp", "" %}

{% image "https://img.antares.xin/assets/nwys/19.webp", "" %}
...
>    {% image "https://img.antares.xin/assets/nwys/20.png", "配置文件" %}
